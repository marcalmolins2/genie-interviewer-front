...
export default function InterviewerCreationSelector() {
  return (
    <div className="container max-w-4xl py-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Create New Interviewer</h1>
        <p className="text-muted-foreground text-lg">
          Choose how you'd like to create your interview interviewer
        </p>
      </div>
      ...
      <div className="text-center mt-8 text-sm text-muted-foreground">
        Both methods create equally powerful interviewers. Choose based on your preference and experience level.
      </div>
    </div>
  );
}
